...
class CloudMusicSpider:
    def __init__(self):
        ...
        self.playlists = {
            ...
            '1978921795': {'name': '电音榜', 'type': '电子音乐'},
            '14028249541': {'name': '全球说唱榜', 'type': '欧美说唱'},
            '991319590': {'name': '中文说唱榜', 'type': '中文说唱'},
            '71385702': {'name': '电音榜', 'type': '电子'},
            '71384707': {'name': 'ACG榜', 'type': 'ACG'},
            '5059642701': {'name': '欧美榜', 'type': '欧美'},
            '5059633707': {'name': '韩国榜', 'type': '韩语'},
            '5059644681': {'name': '日本榜', 'type': '日语'}
        }
    ...
    def run_spider(self, get_urls=False):
        """运行爬虫，爬取所有歌单
...
if __name__ == '__main__':
    ...
    spider.run_spider(get_urls=get_urls)